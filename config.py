...
DEFAULT_CHAMPS_WORKSHEET_NAME = "Champs"
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        worksheet_name=os.getenv("ABILITIES_WORKSHEET_NAME", DEFAULT_WORKSHEET_NAME).strip(),
        ...
        champs_worksheet_name=os.getenv("CHAMPS_WORKSHEET_NAME", DEFAULT_CHAMPS_WORKSHEET_NAME).strip(),
    )
